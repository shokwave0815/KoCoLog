...
function StringListToStringGrid(AllLines: TStringList; aSG: TStringGrid;
...
var
  ...
  begin
    ...
    begin
      ...
      if (not Form_Filter.IsFiltered or Form_Filter.MatchAllFilters(
        SplittedLine)) then
      begin
...
function ExtractEntry(aString: string): TStringList;
  ...
  begin
    ...
    begin
      tmpString := copy(aString, aOffset + aLength, Pos('}', aString, aOffset) -
        aOffset - aLength);
    end
    else
    begin
