...
uses
	   ...
	   ExtCtrls, klfilter, Types, INIFiles, kltextutil, klcourse;

const
	   MY_VERSION = 'KoCoLog V0.7.13c';
...
type
	   ...
	   TForm_Main = class(TForm)
					   ...
					   procedure StringGrid_MainDrawCell(Sender: TObject; aCol, aRow: integer; aRect: TRect;
